...
export const SUBSTATUS_OPTIONS: Record<OrderStatus, string[]> = {
  ...
  SHIPPED: [
    'Recibido por la empresa logística',
    'Clasificado en centro internacional',
    'En tránsito internacional',
    'Salió del país de origen',
  ],
  ARRIVED_COUNTRY: [
    'Arribó al país de destino',
    'Recibido en centro internacional',
    'Esperando ingreso aduanero',
  ],
  CUSTOMS: [
    'Ingresó a aduana',
