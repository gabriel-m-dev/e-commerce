...
export default async function NuevosIngresosNikePage() {
  const [products, config] = await Promise.all([
    getNewProducts(20, 'NIKE'),
    getSiteConfig('newArrivalsNike'),
  ])
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-[13px] font-black uppercase tracking-[0.22em]">Nuevos Ingresos Nike</h1>
      </div>
      <p className="text-[12px] text-muted -mt-4 uppercase tracking-[0.12em]">
        Arrastrá los productos para definir el orden en que aparecen en la sección de nuevos ingresos de Nike.
      </p>
