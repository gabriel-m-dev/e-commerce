      ...
      <div className="relative">
        ...
        {canPrev && (
          <button
            onClick={scrollPrev}
            aria-label="Anterior"
            className="absolute left-0 top-1/2 z-10 -translate-y-1/2 -translate-x-1 flex h-11 w-11 items-center justify-center bg-foreground/80 text-white transition-opacity hover:bg-foreground md:hidden"
          >
        ...
        {canNext && (
          <button
            ...
            className="absolute right-0 top-1/2 z-10 -translate-y-1/2 translate-x-1 flex h-11 w-11 items-center justify-center bg-foreground/80 text-white transition-opacity hover:bg-foreground md:hidden"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
